const languageMeta={es:['\u{1F1EA}\u{1F1F8}','ES','Español'],ca:['\u{1F1E6}\u{1F1E9}','CA','Català'],en:['\u{1F1EC}\u{1F1E7}','EN','English'],fr:['\u{1F1EB}\u{1F1F7}','FR','Français'],de:['\u{1F1E9}\u{1F1EA}','DE','Deutsch']};
window.addEventListener('DOMContentLoaded',()=>{
 ...
 select.dataset.enhanced='true';select.style.display='none';
 const picker=document.createElement('div');picker.className='language-picker';
 const button=document.createElement('button');button.type='button';button.className='language-picker__button';
 const menu=document.createElement('div');menu.className='language-picker__menu';
